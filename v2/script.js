...
const modalData = {
    ...
    representativeUnion: {
        ...
        content: `
            ...
            <p>결국, 막강한 힘과 무거운 책임을 가진 교섭대표노동조합이 우리 사업장 내 '작은 국회'처럼 얼마나 책임감을 갖고, 모든 동료들의 목소리를 소외 없이 골고루 담아내며 주도적으로 활동하느냐에 따라, 우리 모두를 위한 약속 즉, 우리 모두의 권익을 지켜줄 직장 규칙의 수준과 깊이가 결정된답니다.</p>
    ...
    bargainingUnificationProblems: {
        title: "<i class='fa-solid fa-people-group card-icon'></i> 물류 노동자는 물류노조로 뭉치자!",
        content: `
